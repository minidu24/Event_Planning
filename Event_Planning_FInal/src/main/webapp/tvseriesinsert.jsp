				  ...
				  <div class="form">
				      ...
				      <div class="tab-content">
				        <div id="signup">
				          ...
				          <form action="tvseriesinsert" method="post">
					          ...
					          <div class="field-wrap">
					            ...
					            <input type="text" name="e_dis"/>
					          </div>
					          
					          <div class="field-wrap">
					            <label>
					              Accountant decision<span class="req">*</span>
					            </label>
					            <!-- <input type="text" name="director"/> -->
					            <select name="a_Dicession" id="a_Dicession">
					          ...
					          <a>
					          	<button type="submit" class="button button-block">Generate Bill</button>
					          </a>
