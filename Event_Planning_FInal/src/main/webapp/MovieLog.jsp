	...
	<div id="shell">
			  ...
			  <div class="form">
					<div class="form2">
					      ...
					      <ul class="tab-group">
					        <li class="tab active"><a href="#signup">Insert Employee Name</a></li>
					      </ul>
					      
					      <div class="tab-content">
					        <div id="signup">
					          
					          <form action="MovieLogServlet" method="post">
					          
						          <div class="field-wrap">
						            <input type="text" name="emp_name" onfocus="clearContents(this);" required/>
						          </div>
