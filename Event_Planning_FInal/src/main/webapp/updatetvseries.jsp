	...
	<div id="shell">
			  <div id="header1">
			    ...
			    <div id="navigation">
			     <ul>
			        ...
			        <li><a class="active" href="Selection.jsp">ADMIN</a></li>
			  ...
			  <div class="form2">
				  <div class="form">
				      ...
				      <ul class="tab-group">
				        <li class="tab active"><a href="#signup">Update Bill</a></li>
				      </ul>
				      
				      <div class="tab-content">
				        <div id="signup">
				          
				          <form action="getUpdatedList_Servlet" method="post">
				          ...
				          <div class="field-wrap">
				            ...
				            <input type="text" name="e_Code" value="<%= e_Code %>">				            
				          </div>
				          
				          <div class="field-wrap">
				            <label>
				              Total Cost <span class="req">*</span>
				            </label>
				            <input type="text" name="t_Cost" value="<%= t_Cost %>">				            
				          </div>
				          
				          <div class="field-wrap">
				            <label>
				              Discounts <span class="req">*</span>
				            </label>
				            <input type="text" name="e_dis" value="<%= e_dis %>">				            
				          </div>
				          
				          <div class="field-wrap">
				            <label>
				              Decission <span class="req">*</span>
				            </label>
				            <input type="text" name="a_Dicession" value="<%= a_Dicession %>">				            
				          </div>
