...
<body translate="no">
	<div id="shell">
			  ...
			  <div class="form">
			  	<a href="tvseriesinsert.jsp">
			  		<center><button class="button button-block"/>NEW BILL</button></center>
			  	</a>
			
			  	<a href="C_AccountantDelete_1.jsp">
			  		<center><button class="button button-block2"/>VIEW BILLS</button></center>
			  	</a>
