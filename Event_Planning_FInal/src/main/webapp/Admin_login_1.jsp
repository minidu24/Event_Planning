...
<body translate="no">
	<div id="shell">
			  ...
			  <div class="form">
			  	<a href="C_AccountantInsert_1.jsp">
			  		<center><button class="button button-block"/>Accountant</button></center>
			  	</a>
			  	
			  	<a href="B_EventplannerInsert_1.jsp">
			  		<center><button class="button button-block1"/>System Admin</button></center>
			  	</a>
			  	
			  	<form action="updateMTservelet" method="post">
			  		<center><button class="button button-block2"/>Event Planner</button></center>
			  	</form>
			  </div> <!-- /form -->
